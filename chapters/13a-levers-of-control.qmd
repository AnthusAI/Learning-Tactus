...
| Take the blade away | prevent whole classes of incidents | explicit tool lists; per-stage tool enabling; brokers | Ch 14–16 |
| Put it in a cage | contain damage when mistakes happen | Lua sandbox; container isolation | Ch 14–16 (esp. sandboxing + runners) |
| Human handoff | accountability before risk | `Human.review/approve/input` | Ch 10 (and reinforced in Part III) |
| Dashboards + alarms | detect drift and enforce policy | traces/state/stages; specs; evals | Ch 11–13 and throughout |
