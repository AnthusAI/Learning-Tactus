...
If your runtime container contains `OPENAI_API_KEY`, SMTP credentials, database tokens, or cloud keys, then prompt injection and tool misuse can still become data exfiltration.
...
A useful mental model is to define “runner” modes:
...
- a path to secretless execution via brokers and tool runners
