...
**Part I: Foundations** explains what Tactus is and the two design choices that make it different: transparent durability and everything-as-code.

**Part II: Build a Useful Agent** walks through a single running example that we keep extending until it’s genuinely useful.

**Part III: Reliability and Correctness at Scale** adds the testing and engineering patterns you need to trust the workflow unattended.

**Part IV: Secure Execution at Scale** focuses on information security: sandboxing, isolation boundaries, and keeping secrets out of untrusted runtimes.
