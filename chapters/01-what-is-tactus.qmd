...
**Part I: Getting Started** gets you running: installation, configuration, and your first agent.

**Part II: A Workflow You Can Grow** introduces Tactus’s differentiators the practical way: we’ll start with a small “meeting recap” workflow and layer on tools, human approval before sending emails, durability, and behavior specs.

**Part III: Core Patterns** goes deeper on the building blocks you’ll reuse everywhere: typed inputs/outputs, state, and safe multi-turn orchestration.

**Part IV: Testing and Reliability** covers step definitions, mocking patterns, and evaluations—so you can measure “how often does it work?” instead of hoping.
...
In the next chapter, you’ll define your first agent and start building a small workflow we’ll grow throughout the book.
