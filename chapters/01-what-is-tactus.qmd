...
3. Returns the agent's response as typed output
...
**Part II** (Chapters 4-6) gets you started—installation, basic syntax, and your first agent. We'll also start embedding specs early, because every real procedure needs a definition of "done."
...
4. Run its BDD spec (requires an API key): `tactus test code/chapter-01/04-basics-simple-agent.tac`
