...
```lua {file="code/chapter-01/04-basics-simple-agent.tac" snippet="durable-checkpoint-loop" show-path="true"}
```
...
```lua {file="code/chapter-02/10-feature-state.tac" show-path="true"}
```
