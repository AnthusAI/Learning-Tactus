...
::: {.subtitle}
Durable Orchestration for Tool-Using AI Agents
:::
...
- **Part I** lays the foundations: what Tactus is, plus transparent durability and everything-as-code.
- **Part II** builds a useful agent workflow by iteratively extending a single running example (including HITL).
- **Part III** focuses on reliability and correctness: state/idempotency, specs, and evaluations.
- **Part IV** focuses on secure execution and information security: sandboxing, isolation boundaries, and keeping secrets out of untrusted runtimes.
